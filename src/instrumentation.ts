...
// import { InstrumentationLogger } from './logger/instrumentation-logger';
//
// if (process.env?.INSTRUMENTATION_ENABLED == 'true' && isMainThread) {
...
//           },
//           responseHook: (span: Span, info) => {
//             logger.generateUndiciLog(info);
//           },
...
//             logger.generateHttpLog(response);
//           },
